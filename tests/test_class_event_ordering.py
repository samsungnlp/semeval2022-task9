...
from src.pipeline.answerers.event_ordering_v2 import QuestionAnswererEventOrdering, PredictedAnswer, EoEvent
from src.pipeline.question_category import QuestionCategory
from src.unpack_data import Recipe, Q_A, QuestionAnswerRecipe


class TestQAClassEventOrdering(unittest.TestCase):
    ...
    def test_prediction5(self):
        ...
        q_a = Q_A.build_dummy_qa(q, "0-0", "the first event")
        question = QuestionAnswerRecipe(q_a, recipe)

        engine = QuestionAnswererEventOrdering()
    ...
    def test_prediction2(self):
        ...
        q_a = Q_A.build_dummy_qa(q, "1-1", "the second event")
        question = QuestionAnswerRecipe(q_a, recipe)
    ...
    def test_prediction1(self):
        ...
        q_a = Q_A.build_dummy_qa(q, "2-2", "the second event")
        question = QuestionAnswerRecipe(q_a, recipe)
    ...
    def test_prediction0(self):
        ...
        q_a = Q_A.build_dummy_qa(q, "3-3", "the first event")
        question = QuestionAnswerRecipe(q_a, recipe)
    ...
    def test_extract_event(self):
        ...
        self.assertIsInstance(res, EoEvent)
