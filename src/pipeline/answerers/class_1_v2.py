...
class QuestionAnswerer1Class8Style(QuestionAnsweringBase):
    ...
    def answer_a_question(self, question: QuestionAnswerRecipe, question_category: QuestionCategory,
        ...
        """
        Answers the question "what should be", belonging to class 1. Iterate over paragraphs and semantic
        ...
        :return: answer
        """
        more_info_for_answer = {"source": QuestionAnswerer1Class8Style.DESCRIPTION}
