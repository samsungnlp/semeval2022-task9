...
class QuestionAnswerer0(QuestionAnsweringBase):
    DESCRIPTION = "QuestionAnswerer counting things"

    """
    Answers the question "How many actions does it take to... ?", "How many X are used?", "How many times X is used?"
    belonging to class 0. 
    :param question: question to be answered
    :param question_category: assumed to be 0
    ...
    def answer_a_question(self, question: QuestionAnswerRecipe, question_category: QuestionCategory,
        ...
        more_info_for_answer = {"source": QuestionAnswerer0.DESCRIPTION,
