...
class QuestionAnswerer17(QuestionAnsweringBase):
    ...
    def answer_a_question(self, question: QuestionAnswerRecipe, question_category: QuestionCategory,
        ...
        :return: answer
        """
        more_info_for_answer = {"source": QuestionAnswerer17.DESCRIPTION}

        answer2, diagnostics = self.try_answer_v2_89(question, more_info)
    ...
    def try_answer_v2_89(self, question, more_info) -> str:
        """
        ...
        verb = QuestionAnswerer17.get_reference_verb_from_question(question.question)
        lemmatized_verb = self.lemmatizer.lemmatize_verb(verb)
        print(f"V = {lemmatized_verb}", file=self.outstream)
        context = QuestionAnswerer17.get_question_context(question.question)
    ...
    def get_final_from_candidates(self, candidates):
        ...
        if len(ret) != 1:
            ...
            print(f"Non-unique answer to C17 = {ret}", file=self.outstream)
        return ret[-1]
