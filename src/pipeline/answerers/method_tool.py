...
class QuestionAnswererMethodTool:
    ...
    def answer_method_tool_question(self, question: QuestionAnswerRecipe) -> Tuple[str, Dict[str, str]]:

        """
        Answers the question "how do you", belonging to class Method Tool.
        Iterate over paragraphs and semantic role's columns to find specified labels and relations.
        :param question: question to be answered
        :return: answer
        """
        more_info_for_answer = {"source": QuestionAnswererMethodTool.DESCRIPTION}
        ...
        if answer:
            more_info_for_answer["details_for_excel"] = f"semantics || Method / Tool"
            return self.final_answer(answer), more_info_for_answer

        answer = self.steps_and_columns_iteration(question.recipe, question.question.lower(), paragraphs,
                                                  semantics=False, use_drop_column=True)
        if answer:
            more_info_for_answer["details_for_excel"] = f"relation || Method / Tool"
            return self.final_answer(answer), more_info_for_answer

        more_info_for_answer["details_for_excel"] = "no match || Method / Tool"
