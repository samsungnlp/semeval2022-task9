...
class QuestionAnswererEllipsisV1(QuestionAnsweringBase):
    """
    For the question class Ellipsis ("What should be" + participle) we look for the verb in the participle in the
    question.
