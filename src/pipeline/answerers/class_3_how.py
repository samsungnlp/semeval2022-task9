...
class QuestionAnswerer3How(QuestionAnsweringBase):
    DESCRIPTION = "QuestionAnswerer for class 3_how"
    ...
    def answer_a_question(self, question: QuestionAnswerRecipe, question_category: QuestionCategory,
        ...
        """
        Answers the question "How did you get", belonging to class 3
        ...
        """
        more_info_for_answer = {"source": QuestionAnswerer3How.DESCRIPTION}
        answer = None
