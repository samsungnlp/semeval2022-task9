...
class QuestionAnswerer5(QuestionAnsweringBase):
    ...
    def answer_a_question(self, question: QuestionAnswerRecipe, question_category: QuestionCategory,
        ...
        """
        Answers the question "to what extent", belonging to class 5. Assumes the answer sought
        consist of a verb, next the word "till" or "until" followed by some phrase ended with
        a punctuation mark.
        :param question: question to be answered
        :param question_category: assumed to be 5
        :param more_info: ignored
        :return: answer about the extent
        """
        more_info_for_answer = {"source": QuestionAnswerer5.DESCRIPTION}
